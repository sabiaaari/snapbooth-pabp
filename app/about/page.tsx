    ...
    <div className="max-w-7xl mx-auto px-6 md:px-12 space-y-24 py-10 font-serif text-y2k-primary">
      ...
      <header className="text-center space-y-8 max-w-4xl mx-auto">
        ...
        <h1 className="text-6xl md:text-8xl font-heading font-black tracking-tighter leading-none uppercase italic">
          Tentang <span className="text-y2k-primary">SnapBooth</span>
        </h1>
      ...
      <section className="space-y-16">
        <div className="text-center">
            <h2 className="text-4xl md:text-5xl font-heading font-black tracking-tighter uppercase italic">Cara Penggunaan</h2>
                ...
                <div className="space-y-6">
                    <div className="flex gap-4">
                        ...
                        <p className="text-white/70 font-bold text-lg leading-relaxed font-serif">
                            <span className="text-white font-heading font-black text-xl">Aset Pribadi:</span> Frame yang Anda buat bersifat privat dan hanya dapat diakses oleh Anda di Studio Frame Pribadi.
                        </p>
                    </div>
                    <div className="flex gap-4">
                        <Sparkles className="text-white/80 shrink-0" size={28} />
                        <p className="text-white/70 font-bold text-lg leading-relaxed font-serif">
                            <span className="text-white font-heading font-black text-xl">Tersedia pada 2 Platform:</span> SnapBooth dapat berjalan di platform webiste dan mobile.
                        </p>
                    </div>
                </div>
            </div>
            <div className="bg-white/10 backdrop-blur-xl p-12 rounded-[3rem] border-4 border-white/20 space-y-8 text-center">
                <p className="text-3xl font-heading font-black lowercase">Siap untuk mulai menjepret?</p>
